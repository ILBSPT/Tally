# 1 "./../code/random_walk.c"
# 1 "/code/tallyproj/gcctally_v3/bin//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 4 "./../code/random_walk.c" 2

# 1 "./../code/./../include/graph_api.h" 1



# 1 "./../code/./../include/minithread_api.h" 1
...
# 8 "./../code/./../include/minithread_api.h" 2


# 1 "./../code/./../include/minithread_struct.h" 1
...
# 5 "./../code/./../include/graph_api.h" 2
# 1 "./../code/./../include/graph.h" 1
...
# 6 "./../code/./../include/graph_api.h" 2

void add_hop();
int get_n_nodes();
int get_n_neighbours(int node);
int get_x_neighbour(int node, int index);
# 6 "./../code/random_walk.c" 2
# 1 "./../code/./../include/graph_func.h" 1
...
# 7 "./../code/random_walk.c" 2

# 1 "./../code/./../include/minithread_api.h" 1
# 9 "./../code/random_walk.c" 2
...
int walk(int u){
 while(1){
  ...
  threadInUse->state=4; asm volatile("add $1, %r15"); asm volatile("push ._minithread_yeild_label_" "0" "@GOTPCREL(%rip)"); asm volatile("push _minithread_break@GOTPCREL(%rip)"); asm volatile("ret"); asm volatile("._minithread_yeild_label_" "0" ":");
 }
}
